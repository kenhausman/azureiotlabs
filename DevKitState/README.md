...
Finish the [Introduction to Azure IoT Hub and Connect MXChip](./IoTHub/README.md) to:
...
![IoT Device Workbench, select DevKit State example](images/open-example-devkitstate.jpg)

A popup will show asking to restore packages. Click **Restore** to restore the NuGet packages for the Azure Functions app.

![Azure Functions app restore packages](images/functions-restore-packages.png)
...
![IoT Device Workbench: Cloud -> Provision steps](images/iot-workbench-cloud-provision-steps3.png)
...
2. The screen displays the DevKit ID and 'Configuration'.
   ...
   ![IoT DevKit Configuration Mode](images/devkit-configuration-mode.png)
...
5. Then select **Select IoT Hub Device Connection String**.
   ...
   ![IoT Workbench: Device -> Settings -> Connection string](images/iot-workbench-device-connectionstring.png)

6. Select **Select IoT Hub Device Connection String**.

   ![IoT Workbench: Device -> Connection string -> Select](images/iot-workbench-device-string1.png)
...
7. Click **OK** on the popup to confirm the device is in Configuration mode.
   ...
   ![IoT DevKit Confirm configuration mode](images/devkit-configuration-mode-popup.png)
...
2. VS Code then starts verifying and uploading the code to your DevKit.
   ...
   ![IoT Device Workbench: Device -> Uploaded](images/devkitstate-device-upload.jpg)
...
![web page](images/devkit-state-function-app-name.png)
...
![devkit state](images/devkit-state.gif)